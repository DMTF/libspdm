...
bool libspdm_write_key_pair_info(
    ...
    bool *need_reset)
{
    return libspdm_write_key_pair_info_ex(
        spdm_context, key_pair_id, operation, desired_key_usage,
        desired_asym_algo, 0, desired_assoc_cert_slot_mask, need_reset);
}
