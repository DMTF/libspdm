    ...
    uint32_t pqc_asym_algo, void **data, size_t *size)
{
    ...
    case SPDM_ALGORITHMS_PQC_ASYM_ALGO_SLH_DSA_SHA2_128S:
        file = "slh-dsa-sha2-128s/end_responder.key.pub.der";
        break;
    case SPDM_ALGORITHMS_PQC_ASYM_ALGO_SLH_DSA_SHAKE_128S:
        file = "slh-dsa-shake-128s/end_responder.key.pub.der";
        break;
    case SPDM_ALGORITHMS_PQC_ASYM_ALGO_SLH_DSA_SHA2_128F:
        file = "slh-dsa-sha2-128f/end_responder.key.pub.der";
        break;
    case SPDM_ALGORITHMS_PQC_ASYM_ALGO_SLH_DSA_SHAKE_128F:
        file = "slh-dsa-shake-128f/end_responder.key.pub.der";
        break;
    case SPDM_ALGORITHMS_PQC_ASYM_ALGO_SLH_DSA_SHA2_192S:
        file = "slh-dsa-sha2-192s/end_responder.key.pub.der";
        break;
    case SPDM_ALGORITHMS_PQC_ASYM_ALGO_SLH_DSA_SHAKE_192S:
        file = "slh-dsa-shake-192s/end_responder.key.pub.der";
        break;
    case SPDM_ALGORITHMS_PQC_ASYM_ALGO_SLH_DSA_SHA2_192F:
        file = "slh-dsa-sha2-192f/end_responder.key.pub.der";
        break;
    case SPDM_ALGORITHMS_PQC_ASYM_ALGO_SLH_DSA_SHAKE_192F:
        file = "slh-dsa-shake-192f/end_responder.key.pub.der";
        break;
    case SPDM_ALGORITHMS_PQC_ASYM_ALGO_SLH_DSA_SHA2_256S:
        file = "slh-dsa-sha2-256s/end_responder.key.pub.der";
        break;
    case SPDM_ALGORITHMS_PQC_ASYM_ALGO_SLH_DSA_SHAKE_256S:
        file = "slh-dsa-shake-256s/end_responder.key.pub.der";
        break;
    case SPDM_ALGORITHMS_PQC_ASYM_ALGO_SLH_DSA_SHA2_256F:
        file = "slh-dsa-sha2-256f/end_responder.key.pub.der";
        break;
    case SPDM_ALGORITHMS_PQC_ASYM_ALGO_SLH_DSA_SHAKE_256F:
        file = "slh-dsa-shake-256f/end_responder.key.pub.der";
        break;
    default:
    ...
    uint32_t req_pqc_asym_alg, void **data, size_t *size)
{
    ...
    case SPDM_ALGORITHMS_PQC_ASYM_ALGO_ML_DSA_87:
        ...
        break;
    case SPDM_ALGORITHMS_PQC_ASYM_ALGO_SLH_DSA_SHA2_128S:
        file = "slh-dsa-sha2-128s/end_requester.key.pub.der";
        break;
    case SPDM_ALGORITHMS_PQC_ASYM_ALGO_SLH_DSA_SHAKE_128S:
        file = "slh-dsa-shake-128s/end_requester.key.pub.der";
        break;
    case SPDM_ALGORITHMS_PQC_ASYM_ALGO_SLH_DSA_SHA2_128F:
        file = "slh-dsa-sha2-128f/end_requester.key.pub.der";
        break;
    case SPDM_ALGORITHMS_PQC_ASYM_ALGO_SLH_DSA_SHAKE_128F:
        file = "slh-dsa-shake-128f/end_requester.key.pub.der";
        break;
    case SPDM_ALGORITHMS_PQC_ASYM_ALGO_SLH_DSA_SHA2_192S:
        file = "slh-dsa-sha2-192s/end_requester.key.pub.der";
        break;
    case SPDM_ALGORITHMS_PQC_ASYM_ALGO_SLH_DSA_SHAKE_192S:
        file = "slh-dsa-shake-192s/end_requester.key.pub.der";
        break;
    case SPDM_ALGORITHMS_PQC_ASYM_ALGO_SLH_DSA_SHA2_192F:
        file = "slh-dsa-sha2-192f/end_requester.key.pub.der";
        break;
    case SPDM_ALGORITHMS_PQC_ASYM_ALGO_SLH_DSA_SHAKE_192F:
        file = "slh-dsa-shake-192f/end_requester.key.pub.der";
        break;
    case SPDM_ALGORITHMS_PQC_ASYM_ALGO_SLH_DSA_SHA2_256S:
        file = "slh-dsa-sha2-256s/end_requester.key.pub.der";
        break;
    case SPDM_ALGORITHMS_PQC_ASYM_ALGO_SLH_DSA_SHAKE_256S:
        file = "slh-dsa-shake-256s/end_requester.key.pub.der";
        break;
    case SPDM_ALGORITHMS_PQC_ASYM_ALGO_SLH_DSA_SHA2_256F:
        file = "slh-dsa-sha2-256f/end_requester.key.pub.der";
        break;
    case SPDM_ALGORITHMS_PQC_ASYM_ALGO_SLH_DSA_SHAKE_256F:
        file = "slh-dsa-shake-256f/end_requester.key.pub.der";
        break;
    default:
        LIBSPDM_ASSERT(false);
        return false;
