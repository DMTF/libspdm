    ...
    size_t *size, void **hash, size_t *hash_size)
{
    ...
    *size = 0;
    ...
    res = libspdm_verify_cert_chain_data(SPDM_MESSAGE_VERSION_14,
                                         file_data, file_size,
    ...
    size_t *size, void **hash, size_t *hash_size)
{
    ...
    *size = 0;
    ...
    res = libspdm_x509_set_cert_certificate_check(SPDM_MESSAGE_VERSION_14,
    ...
    size_t *size, void **hash, size_t *hash_size)
{
    ...
    *size = 0;
    ...
    res = libspdm_x509_certificate_check(SPDM_MESSAGE_VERSION_14,
                                         leaf_cert, leaf_cert_len,
                                         0, pqc_asym_algo, base_hash_algo,
                                         is_requester_cert, is_device_cert_model);
    if (!res) {
    ...
    void **data, size_t *size, void **hash, size_t *hash_size)
{
    ...
    *size = 0;
    ...
    res = libspdm_verify_cert_chain_data(SPDM_MESSAGE_VERSION_14, file_data, file_size,
                                         0, pqc_asym_algo, base_hash_algo,
                                         is_requester_cert, is_device_cert_model);
    if (!res) {
        free(file_data);
