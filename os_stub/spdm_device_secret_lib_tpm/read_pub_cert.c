...
static bool get_certificate(const char *handle, uint32_t base_hash_algo, uint32_t base_asym_algo, void **data,
...
static bool get_certificate_chain(const char *filename, uint32_t base_hash_algo, uint32_t base_asym_algo, void **data,
                                  size_t *size, void **hash, size_t *hash_size,
...
bool libspdm_read_requester_public_certificate_chain(
    ...
    size_t *size, void **hash, size_t *hash_size)
{
    return get_certificate_chain("requester_certchain.der", base_hash_algo, req_base_asym_alg, data, size, hash,
...
bool libspdm_read_responder_public_certificate_chain(
    ...
    size_t *size, void **hash, size_t *hash_size)
{
    return get_certificate_chain("responder_certchain.der", base_hash_algo, base_asym_algo, data, size, hash, hash_size,
                                 false, true);
}
