...
boolean sha256_init(OUT void *sha256_context)
{
	...
	//
	return (boolean)(SHA256_Init((SHA256_CTX *)sha256_context));
}
			 ...
			 OUT void *new_sha256_context)
{
	...
	copy_mem(new_sha256_context, sha256_context, sizeof(SHA256_CTX));
		      ...
		      IN uintn data_size)
{
	...
	//
	return (boolean)(
		SHA256_Update((SHA256_CTX *)sha256_context, data, data_size));
}
...
boolean sha256_final(IN OUT void *sha256_context, OUT uint8 *hash_value)
{
	...
	//
	return (boolean)(
		SHA256_Final(hash_value, (SHA256_CTX *)sha256_context));
}
			...
			OUT uint8 *hash_value)
{
	...
	//
	if (SHA256(data, data_size, hash_value) == NULL) {
		return FALSE;
	} else {
		return TRUE;
	}
