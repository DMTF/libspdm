 ...
 **/
void test_spdm_requester_encap_key_update_case1(void **state)
{
    ...
    status = spdm_get_encap_response_key_update(spdm_context,
 ...
 * are updated.
 **/
void test_spdm_requester_encap_key_update_case2(void **state)
{
    return_status status;
    spdm_test_context_t *spdm_test_context;
    spdm_context_t *spdm_context;
...
void test_spdm_requester_encap_key_update_case3(void **state)
{
    return_status status;
    spdm_test_context_t *spdm_test_context;
    spdm_context_t *spdm_context;
 ...
 * updated.
 **/
void test_spdm_requester_encap_key_update_case4(void **state)
{
    return_status status;
    spdm_test_context_t *spdm_test_context;
    spdm_context_t *spdm_context;
 ...
 **/
void test_spdm_requester_encap_key_update_case5(void **state)
{
    return_status status;
    spdm_test_context_t *spdm_test_context;
    spdm_context_t *spdm_context;
 ...
 * an ERROR message indicating the UnsupportedRequest. No keys are updated.
 **/
void test_spdm_requester_encap_key_update_case6(void **state)
{
    return_status status;
    spdm_test_context_t *spdm_test_context;
    spdm_context_t *spdm_context;
 ...
 * are updated.
 **/
void test_spdm_requester_encap_key_update_case7(void **state)
{
    return_status status;
    spdm_test_context_t *spdm_test_context;
    spdm_context_t *spdm_context;
 ...
 * updated.
 **/
void test_spdm_requester_encap_key_update_case8(void **state)
{
    return_status status;
    spdm_test_context_t *spdm_test_context;
    spdm_context_t *spdm_context;
 ...
 * are updated.
 **/
void test_spdm_requester_encap_key_update_case9(void **state)
{
    return_status status;
    spdm_test_context_t *spdm_test_context;
    spdm_context_t *spdm_context;
...
int spdm_requester_encap_key_update_test_main(void)
{
    const struct CMUnitTest spdm_requester_key_update_tests[] = {
        /* Success Case -- UpdateKey*/
        cmocka_unit_test(test_spdm_requester_encap_key_update_case1),
        /* Bad request size*/
        cmocka_unit_test(test_spdm_requester_encap_key_update_case2),
        /* Buffer reset*/
        cmocka_unit_test(test_spdm_requester_encap_key_update_case3),
        /* Unsupported KEY_UPD capabilities*/
        cmocka_unit_test(test_spdm_requester_encap_key_update_case4),
        /* Uninitialized session*/
        cmocka_unit_test(test_spdm_requester_encap_key_update_case5),
        /* ruquster RETURN_UNSUPPORTED*/
        cmocka_unit_test(test_spdm_requester_encap_key_update_case6),
        /* Bad request size*/
        cmocka_unit_test(test_spdm_requester_encap_key_update_case7),
        /* Uninitialized key update*/
        cmocka_unit_test(test_spdm_requester_encap_key_update_case8),
        /* Invalid operation*/
        cmocka_unit_test(test_spdm_requester_encap_key_update_case9),
    };

    setup_spdm_test_context(&m_spdm_requester_encap_key_update_test_context);
