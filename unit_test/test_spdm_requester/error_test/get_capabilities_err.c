...
static void req_get_capabilities_err_case1(void **state)
{
 ...
 **/
static void req_get_capabilities_err_case2(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
...
static void req_get_capabilities_err_case3(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
...
static void req_get_capabilities_err_case4(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
...
static void req_get_capabilities_err_case5(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
 ...
 * Expected behavior: returns with status LIBSPDM_STATUS_INVALID_MSG_FIELD.
 **/
static void req_get_capabilities_err_case6(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
...
static void req_get_capabilities_err_case7(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
...
static void req_get_capabilities_err_case8(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
 ...
 **/
static void req_get_capabilities_err_case9(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
 ...
 * Expected behavior: returns with status LIBSPDM_STATUS_INVALID_MSG_FIELD.
 **/
static void req_get_capabilities_err_case10(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
 ...
 * Expected behavior: returns with status LIBSPDM_STATUS_INVALID_MSG_FIELD.
 **/
static void req_get_capabilities_err_case11(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
 ...
 * Expected behavior: returns with status LIBSPDM_STATUS_INVALID_MSG_FIELD.
 **/
static void req_get_capabilities_err_case12(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
...
static void req_get_capabilities_err_case13(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
...
static void req_get_capabilities_err_case14(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
...
static void req_get_capabilities_err_case15(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
 ...
 * Expected behavior: returns with status LIBSPDM_STATUS_INVALID_MSG_FIELD.
 **/
static void req_get_capabilities_err_case16(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
...
static void req_get_capabilities_err_case17(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
...
static void req_get_capabilities_err_case18(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
...
static void req_get_capabilities_err_case19(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
...
static void req_get_capabilities_err_case20(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
...
static void req_get_capabilities_err_case21(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
...
static void req_get_capabilities_err_case22(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
...
static void req_get_capabilities_err_case23(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
...
static void req_get_capabilities_err_case24(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
...
static void req_get_capabilities_err_case25(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
...
static void req_get_capabilities_err_case26(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
...
static void req_get_capabilities_err_case27(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
...
static void req_get_capabilities_err_case28(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
...
static void req_get_capabilities_err_case29(void **state) {
    libspdm_return_t status;
    libspdm_test_context_t    *spdm_test_context;
    libspdm_context_t  *spdm_context;
    uint16_t error_code;
 ...
 * Expected behavior: returns with status LIBSPDM_STATUS_INVALID_MSG_FIELD.
 **/
static void req_get_capabilities_err_case30(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
...
static void req_get_capabilities_err_case31(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
 ...
 * Expected behavior: returns with status LIBSPDM_STATUS_INVALID_MSG_FIELD.
 **/
static void req_get_capabilities_err_case32(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
 ...
 * Expected behavior: returns with status LIBSPDM_STATUS_INVALID_MSG_FIELD.
 **/
static void req_get_capabilities_err_case33(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
...
static void req_get_capabilities_err_case34(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
 ...
 **/
static void req_get_capabilities_err_case35(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
 ...
 * Expected behavior: returns with status LIBSPDM_STATUS_ACQUIRE_FAIL.
 **/
static void req_get_capabilities_err_case36(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
 ...
 * Expected behavior: returns with status LIBSPDM_STATUS_INVALID_MSG_FIELD.
 **/
static void req_get_capabilities_err_case37(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
 ...
 * Expected behavior: returns with status LIBSPDM_STATUS_INVALID_MSG_FIELD.
 **/
static void req_get_capabilities_err_case38(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
 ...
 * Expected behavior: returns with status LIBSPDM_STATUS_INVALID_MSG_FIELD.
 **/
static void req_get_capabilities_err_case39(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
 ...
 * Expected behavior: returns with status LIBSPDM_STATUS_INVALID_MSG_FIELD.
 **/
static void req_get_capabilities_err_case40(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
 ...
 * Expected behavior: returns with status LIBSPDM_STATUS_INVALID_MSG_FIELD.
 **/
static void req_get_capabilities_err_case41(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
...
int libspdm_req_get_capabilities_error_test(void)
{
    const struct CMUnitTest test_cases[] = {
        cmocka_unit_test(req_get_capabilities_err_case1),
        cmocka_unit_test(req_get_capabilities_err_case2),
        cmocka_unit_test(req_get_capabilities_err_case3),
        cmocka_unit_test(req_get_capabilities_err_case4),
        cmocka_unit_test(req_get_capabilities_err_case5),
        cmocka_unit_test(req_get_capabilities_err_case6),
        cmocka_unit_test(req_get_capabilities_err_case7),
        cmocka_unit_test(req_get_capabilities_err_case8),
        cmocka_unit_test(req_get_capabilities_err_case9),
        cmocka_unit_test(req_get_capabilities_err_case10),
        cmocka_unit_test(req_get_capabilities_err_case11),
        cmocka_unit_test(req_get_capabilities_err_case12),
        cmocka_unit_test(req_get_capabilities_err_case13),
        cmocka_unit_test(req_get_capabilities_err_case14),
        cmocka_unit_test(req_get_capabilities_err_case15),
        cmocka_unit_test(req_get_capabilities_err_case16),
        cmocka_unit_test(req_get_capabilities_err_case17),
        cmocka_unit_test(req_get_capabilities_err_case18),
        cmocka_unit_test(req_get_capabilities_err_case19),
        cmocka_unit_test(req_get_capabilities_err_case20),
        cmocka_unit_test(req_get_capabilities_err_case21),
        cmocka_unit_test(req_get_capabilities_err_case22),
        cmocka_unit_test(req_get_capabilities_err_case23),
        cmocka_unit_test(req_get_capabilities_err_case24),
        cmocka_unit_test(req_get_capabilities_err_case25),
        cmocka_unit_test(req_get_capabilities_err_case26),
        cmocka_unit_test(req_get_capabilities_err_case27),
        cmocka_unit_test(req_get_capabilities_err_case28),
        cmocka_unit_test(req_get_capabilities_err_case29),
        cmocka_unit_test(req_get_capabilities_err_case30),
        cmocka_unit_test(req_get_capabilities_err_case31),
        cmocka_unit_test(req_get_capabilities_err_case32),
        cmocka_unit_test(req_get_capabilities_err_case33),
        cmocka_unit_test(req_get_capabilities_err_case34),
        cmocka_unit_test(req_get_capabilities_err_case35),
        cmocka_unit_test(req_get_capabilities_err_case36),
        cmocka_unit_test(req_get_capabilities_err_case37),
        cmocka_unit_test(req_get_capabilities_err_case38),
        cmocka_unit_test(req_get_capabilities_err_case39),
        cmocka_unit_test(req_get_capabilities_err_case40),
        cmocka_unit_test(req_get_capabilities_err_case41),
    };
