    ...
    void *spdm_context, size_t *response_size, void **response, uint64_t timeout)
{
    ...
    case 0x17: {
        ...
        spdm_response->header.param1 = 0;
        spdm_response->header.param2 = 0;
        spdm_response->version_number_entry_count = LIBSPDM_MAX_VERSION_COUNT + 1;
...
/**
 * Test 1: transport receive fails while waiting for VERSION.
 * Expected behavior: the Requester returns LIBSPDM_STATUS_RECEIVE_FAIL.
 **/
...
/**
 * Test 3: receiving a VERSION response whose entry count is zero.
...
int libspdm_req_get_version_test(void)
{
    const struct CMUnitTest test_cases[] = {
        ...
        cmocka_unit_test(req_get_version_case23),
    };
