 ...
 **/
void test_spdm_responder_encap_digests_case1(void **state)
{
 ...
 **/
void test_spdm_responder_encap_digests_case2(void **state)
{
    return_status status;
    spdm_test_context_t *spdm_test_context;
    spdm_context_t *spdm_context;
 ...
 **/
void test_spdm_responder_encap_digests_case3(void **state)
{
    return_status status;
    spdm_test_context_t *spdm_test_context;
    spdm_context_t *spdm_context;
 ...
 * Expected Behavior: produces an ERROR response message with error code = Unspecified
 **/
void test_spdm_responder_encap_digests_case4(void **state)
{
    spdm_test_context_t *spdm_test_context;
    spdm_context_t *spdm_context;
#if LIBSPDM_RECORD_TRANSCRIPT_DATA_SUPPORT
...
int spdm_responder_encap_digests_test_main(void)
{
    const struct CMUnitTest spdm_responder_digests_tests[] = {
        /* Success Case*/
        cmocka_unit_test(test_spdm_responder_encap_digests_case1),
        /* Bad request size*/
        cmocka_unit_test(test_spdm_responder_encap_digests_case2),
        /* Internal cache full (request message)*/
        cmocka_unit_test(test_spdm_responder_encap_digests_case3),
        /* Internal cache full (response message)*/
        cmocka_unit_test(test_spdm_responder_encap_digests_case4),
    };
