 ...
 **/
void test_spdm_requester_encap_challenge_auth_case1(void **state)
{
    ...
    status = spdm_get_encap_response_challenge_auth(
 ...
 **/
void test_spdm_requester_encap_challenge_auth_case2(void **state)
{
    return_status status;
    spdm_test_context_t *spdm_test_context;
    spdm_context_t *spdm_context;
 ...
 * CHALLENGE_AUTH response message.
 **/
void test_spdm_requester_encap_challenge_auth_case3(void **state)
{
    return_status status;
    spdm_test_context_t *spdm_test_context;
    spdm_context_t *spdm_context;
    ...
    status = spdm_get_encap_response_challenge_auth(spdm_context, m_spdm_challenge_request1_size,
 ...
 **/
void test_spdm_requester_encap_challenge_auth_case4(void **state)
{
    return_status status;
    spdm_test_context_t *spdm_test_context;
    spdm_context_t *spdm_context;
    ...
    response_size = sizeof(response);
    libspdm_get_random_number(SPDM_NONCE_SIZE, m_spdm_challenge_request1.nonce);
    status = spdm_get_encap_response_challenge_auth(spdm_context, m_spdm_challenge_request3_size,
 ...
 * indicating the UnexpectedRequest.
 **/
void test_spdm_requester_encap_challenge_auth_case5(void **state)
{
    return_status status;
    spdm_test_context_t *spdm_test_context;
    spdm_context_t *spdm_context;
...
spdm_test_context_t m_spdm_requester_challenge_auth_test_context = {
    SPDM_TEST_CONTEXT_SIGNATURE,
    false,
};

int spdm_requester_encap_challenge_auth_test_main(void)
{
    const struct CMUnitTest spdm_requester_challenge_auth_tests[] = {
        /* Success Case*/
        cmocka_unit_test(test_spdm_requester_encap_challenge_auth_case1),
        /* Bad request size*/
        cmocka_unit_test(test_spdm_requester_encap_challenge_auth_case2),
        /* connection_state Check*/
        cmocka_unit_test(test_spdm_requester_encap_challenge_auth_case3),
        cmocka_unit_test(test_spdm_requester_encap_challenge_auth_case4),
        cmocka_unit_test(test_spdm_requester_encap_challenge_auth_case5),
    };

    setup_spdm_test_context(&m_spdm_requester_challenge_auth_test_context);
