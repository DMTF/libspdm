...
size_t libspdm_test_get_key_exchange_request_size(const void *spdm_context,
                                                  const void *buffer,
                                                  size_t buffer_size)
{
...
libspdm_return_t libspdm_requester_key_exchange_test_send_message(
...
libspdm_return_t libspdm_requester_key_exchange_test_receive_message(
