...
#define LIBSPDM_TEST_ENDPOINT_INFO_BUFFER_SIZE 12
static uint8_t m_endpoint_info_buffer[LIBSPDM_TEST_ENDPOINT_INFO_BUFFER_SIZE];


static void libspdm_generate_endpoint_info(void)
{
    uint8_t *ptr;
    ...
    ptr = (uint8_t *)m_endpoint_info_buffer;
    ...
    void **response, uint64_t timeout)
{
    ...
    spdm_test_context = libspdm_get_test_context();
    libspdm_generate_endpoint_info();
    switch (spdm_test_context->case_id) {
    case 0x1:
        return LIBSPDM_STATUS_RECEIVE_FAIL;

    case 0x2: { /*correct ENDPOINT_INFO message with signature*/
        ...
        spdm_response_size = sizeof(spdm_endpoint_info_response_t) +
                             ...
                             LIBSPDM_TEST_ENDPOINT_INFO_BUFFER_SIZE +
        ...
        *(uint32_t *)ptr = LIBSPDM_TEST_ENDPOINT_INFO_BUFFER_SIZE; /* ep_info_len */
        ptr += sizeof(uint32_t);

        libspdm_copy_mem(ptr, LIBSPDM_TEST_ENDPOINT_INFO_BUFFER_SIZE,
                         m_endpoint_info_buffer, LIBSPDM_TEST_ENDPOINT_INFO_BUFFER_SIZE);
        ptr += LIBSPDM_TEST_ENDPOINT_INFO_BUFFER_SIZE;
    ...
    case 0x3: { /*ERROR BUSY + ENDPOINT_INFO w/ signature*/
    ...
    case 0x4: { /*ERROR NOT_READY + ENDPOINT_INFO w/ signature*/
    ...
    case 0x5: { /*ERROR SPDM_ERROR_CODE_INVALID_REQUEST*/
        spdm_error_response_t *spdm_response;
        size_t spdm_response_size;
        size_t transport_header_size;
    ...
    case 0x6: { /*ERROR SPDM_ERROR_CODE_BUSY*/
        spdm_error_response_t *spdm_response;
        size_t spdm_response_size;
        size_t transport_header_size;
    ...
    case 0x7: { /*ERROR SPDM_ERROR_CODE_REQUEST_RESYNCH*/
        spdm_error_response_t *spdm_response;
        size_t spdm_response_size;
        size_t transport_header_size;
    ...
    case 0x8: { /*ERROR SPDM_ERROR_CODE_RESPONSE_NOT_READY*/
        spdm_error_response_data_response_not_ready_t *spdm_response;
        size_t spdm_response_size;
        size_t transport_header_size;
    ...
    case 0xA: { /*ENDPOINT_INFO with wrong response code*/
        spdm_endpoint_info_response_t *spdm_response;
        uint8_t *ptr;
        uint8_t hash_data[LIBSPDM_MAX_HASH_SIZE];
        size_t sig_size;
    ...
    case 0xB: { /*ENDPOINT_INFO with wrong version*/
        spdm_endpoint_info_response_t *spdm_response;
        uint8_t *ptr;
        uint8_t hash_data[LIBSPDM_MAX_HASH_SIZE];
        size_t sig_size;
    ...
    case 0xC: { /*ENDPOINT_INFO without signature*/
        spdm_endpoint_info_response_t *spdm_response;
        uint8_t *ptr;
        size_t spdm_response_size;
        size_t transport_header_size;
    ...
    case 0xD: { /*ENDPOINT_INFO with invalid signature (random)*/
        spdm_endpoint_info_response_t *spdm_response;
        uint8_t *ptr;
        size_t sig_size;
        size_t spdm_response_size;
    ...
    case 0xE: { /*ENDPOINT_INFO with invalid signature (all bytes are 0)*/
        spdm_endpoint_info_response_t *spdm_response;
        uint8_t *ptr;
        size_t sig_size;
        size_t spdm_response_size;
    ...
    case 0xF: { /*ENDPOINT_INFO with wrong ep_info_length*/
        spdm_endpoint_info_response_t *spdm_response;
        uint8_t *ptr;
        uint8_t hash_data[LIBSPDM_MAX_HASH_SIZE];
        size_t sig_size;
        ...
        *(uint32_t *)ptr = LIBSPDM_TEST_ENDPOINT_INFO_BUFFER_SIZE + 1; /* ep_info_len */
        ptr += sizeof(uint32_t);
    ...
    case 0x11: { /*correct ENDPOINT_INFO message with signature and slot_id = 1*/
        spdm_endpoint_info_response_t *spdm_response;
        uint8_t *ptr;
        uint8_t hash_data[LIBSPDM_MAX_HASH_SIZE];
        size_t sig_size;
    ...
    case 0x12: { /*correct ENDPOINT_INFO message with signature and use provisioned key*/
        spdm_endpoint_info_response_t *spdm_response;
        uint8_t *ptr;
        uint8_t hash_data[LIBSPDM_MAX_HASH_SIZE];
        size_t sig_size;
    ...
    case 0x13: { /*correct ENDPOINT_INFO message without signature*/
        spdm_endpoint_info_response_t *spdm_response;
        uint8_t *ptr;
        size_t spdm_response_size;
        size_t transport_header_size;
    ...
    case 0x15: { /*ENDPOINT_INFO with wrong slot id*/
        spdm_endpoint_info_response_t *spdm_response;
        uint8_t *ptr;
        size_t spdm_response_size;
        size_t transport_header_size;
    ...
    case 0x16: { /*ENDPOINT_INFO with wrong ep_info_length*/
        spdm_endpoint_info_response_t *spdm_response;
        uint8_t *ptr;
        size_t spdm_response_size;
        size_t transport_header_size;
    ...
    case 0x17: { /*ENDPOINT_INFO message with signature*/
        spdm_endpoint_info_response_t *spdm_response;
        uint8_t *ptr;
        uint8_t hash_data[LIBSPDM_MAX_HASH_SIZE];
        size_t sig_size;
    ...
    case 0x18: { /*correct session based ENDPOINT_INFO message with signature*/
        spdm_endpoint_info_response_t *spdm_response;
        uint8_t *ptr;
        uint8_t hash_data[LIBSPDM_MAX_HASH_SIZE];
        size_t sig_size;
...
/**
 * Test 4: Successful response to get a endpoint info with signature,
...
/**
 * Test 5: Error case, get an error response with code SPDM_ERROR_CODE_INVALID_REQUEST
 * Expected Behavior: get a RETURN_DEVICE_ERROR return code,
 *                    with an empty transcript.message_e
 **/
...
/**
 * Test 6: Error case, always get an error response with code SPDM_ERROR_CODE_BUSY
 * Expected Behavior: get a RETURN_DEVICE_ERROR return code,
 *                    with an empty transcript.message_e
 **/
 ...
 *                    with an empty transcript.message_e
 **/
static void libspdm_test_requester_get_endpoint_info_case8(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
...
/**
 * Test 9: receiving an unexpected ERROR message from the responder.
 ...
 **/
static void libspdm_test_requester_get_endpoint_info_case9(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
...
/**
 * Test 10: Error case, response with wrong response code
 * Expected Behavior: get a RETURN_DEVICE_ERROR return code
 **/
static void libspdm_test_requester_get_endpoint_info_case10(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
...
/**
 * Test 11: Error case, response with wrong version
 * Expected Behavior: get a RETURN_DEVICE_ERROR return code
 **/
static void libspdm_test_requester_get_endpoint_info_case11(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
...
/**
 * Test 12: Error case, response without signature
 * Expected Behavior: get a RETURN_DEVICE_ERROR return code
 **/
static void libspdm_test_requester_get_endpoint_info_case12(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
...
/**
 * Test 13: Error case, response with invalid signature (random)
 * Expected Behavior: get a RETURN_DEVICE_ERROR return code
 **/
static void libspdm_test_requester_get_endpoint_info_case13(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
...
/**
 * Test 14: Error case, response with invalid signature (all bytes are 0)
 * Expected Behavior: get a RETURN_DEVICE_ERROR return code
 **/
static void libspdm_test_requester_get_endpoint_info_case14(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
...
/**
 * Test 15: Error case, response with wrong ep_info_length
 * Expected Behavior: get a RETURN_DEVICE_ERROR return code
 **/
static void libspdm_test_requester_get_endpoint_info_case15(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
...
/**
 * Test 16: Error case, responder capability flag is NO_SIG but request signature
 * Expected Behavior: get a RETURN_DEVICE_ERROR return code
 **/
static void libspdm_test_requester_get_endpoint_info_case16(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
...
/**
 * Test 17: Successful response to get a endpoint info with signature with slot_id = 1
 * Expected Behavior: get a RETURN_SUCCESS return code, with an empty transcript.message_e
 **/
static void libspdm_test_requester_get_endpoint_info_case17(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
...
/**
 * Test 18: Successful response to get a endpoint info with signature
 *          Using provisioned public key (slot_id = 0xF)
 * Expected Behavior: get a RETURN_SUCCESS return code, with an empty transcript.message_e
 **/
static void libspdm_test_requester_get_endpoint_info_case18(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
...
/**
 * Test 19: Successful response to get a endpoint info without signature
 * Expected Behavior: get a RETURN_SUCCESS return code
 **/
static void libspdm_test_requester_get_endpoint_info_case19(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
...
/**
 * Test 20: Error case, request no signature but slot id not 0
 * Expected Behavior: get a RETURN_SUCCESS return code
 **/
static void libspdm_test_requester_get_endpoint_info_case20(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
...
/**
 * Test 21: Error case, request no signature but responder's slot id not 0
 * Expected Behavior: get a RETURN_SUCCESS return code
 **/
static void libspdm_test_requester_get_endpoint_info_case21(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
...
/**
 * Test 22: Error case, request no signature and response with wrong ep_info_length
 * Expected Behavior: get a RETURN_SUCCESS return code
 **/
static void libspdm_test_requester_get_endpoint_info_case22(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
...
/**
 * Test 23: Error case, request no signature but response with signature
 * Expected Behavior: get a RETURN_SUCCESS return code
 **/
static void libspdm_test_requester_get_endpoint_info_case23(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
...
/**
 * Test 24: Successful response to get a session based endpoint info with signature
 * Expected Behavior: get a RETURN_SUCCESS return code, with an empty session_transcript.message_e
 **/
static void libspdm_test_requester_get_endpoint_info_case24(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
...
int libspdm_requester_get_endpoint_info_test_main(void)
{
    const struct CMUnitTest spdm_requester_get_endpoint_info_tests[] = {
        ...
        cmocka_unit_test(libspdm_test_requester_get_endpoint_info_case8),
        cmocka_unit_test(libspdm_test_requester_get_endpoint_info_case9),
        cmocka_unit_test(libspdm_test_requester_get_endpoint_info_case10),
        cmocka_unit_test(libspdm_test_requester_get_endpoint_info_case11),
        cmocka_unit_test(libspdm_test_requester_get_endpoint_info_case12),
        cmocka_unit_test(libspdm_test_requester_get_endpoint_info_case13),
        cmocka_unit_test(libspdm_test_requester_get_endpoint_info_case14),
        cmocka_unit_test(libspdm_test_requester_get_endpoint_info_case15),
        cmocka_unit_test(libspdm_test_requester_get_endpoint_info_case16),
        cmocka_unit_test(libspdm_test_requester_get_endpoint_info_case17),
        cmocka_unit_test(libspdm_test_requester_get_endpoint_info_case18),
        cmocka_unit_test(libspdm_test_requester_get_endpoint_info_case19),
        cmocka_unit_test(libspdm_test_requester_get_endpoint_info_case20),
        cmocka_unit_test(libspdm_test_requester_get_endpoint_info_case21),
        cmocka_unit_test(libspdm_test_requester_get_endpoint_info_case22),
        cmocka_unit_test(libspdm_test_requester_get_endpoint_info_case23),
        cmocka_unit_test(libspdm_test_requester_get_endpoint_info_case24),
    };
