...
/**
 * Test 38: requester receives invalid responder MULTI_KEY_CAP bits in SPDM 1.3.
 * Expected behavior: libspdm_negotiate_algorithms() returns LIBSPDM_STATUS_INVALID_MSG_FIELD.
 **/
