...
libspdm_return_t libspdm_requester_get_measurements_test_send_message(
...
libspdm_return_t libspdm_requester_get_measurements_test_receive_message(
...
void libspdm_test_requester_get_measurements_case16(void **state)
{
    ...
    for (int i = 0; i < sizeof(SlotIDs) / sizeof(SlotIDs[0]); i++) {
        ...
        libspdm_copy_mem(spdm_context->connection_info.peer_used_cert_chain[SlotIDs[i]].buffer,
                         sizeof(spdm_context->connection_info.peer_used_cert_chain[SlotIDs[i]].buffer),
                         data, data_size);
    }
#else
    for (int i = 0; i < sizeof(SlotIDs) / sizeof(SlotIDs[0]); i++) {
...
void libspdm_test_requester_get_measurements_case36(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
...
void libspdm_test_requester_get_measurements_case37(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
...
int libspdm_requester_get_measurements_test_main(void)
{
    const struct CMUnitTest spdm_requester_get_measurements_tests[] = {
        ...
        /* Successful response V1.2 to get measurement with signature*/
