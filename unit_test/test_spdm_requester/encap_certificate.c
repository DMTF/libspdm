 ...
 **/
void test_spdm_requester_encap_certificate_case1(void **state)
{
    ...
    read_responder_public_certificate_chain(m_use_hash_algo, m_use_asym_algo,
    ...
    status = spdm_get_encap_response_certificate(
 ...
 **/
void test_spdm_requester_encap_certificate_case2(void **state)
{
    return_status status;
    spdm_test_context_t *spdm_test_context;
    spdm_context_t *spdm_context;
 ...
 **/
void test_spdm_requester_encap_certificate_case3(void **state)
{
    return_status status;
    spdm_test_context_t *spdm_test_context;
    spdm_context_t *spdm_context;
 ...
 * messages, including its portion_length and remainder_length fields
 **/
void test_spdm_requester_encap_certificate_case4(void **state)
{
    return_status status;
    spdm_test_context_t *spdm_test_context;
    spdm_context_t *spdm_context;
 ...
 * fields
 **/
void test_spdm_requester_encap_certificate_case5(void **state)
{
    return_status status;
    spdm_test_context_t *spdm_test_context;
    spdm_context_t *spdm_context;
    ...
    uint16_t test_cases[] = {TEST_CERT_MAXINT16, TEST_CERT_MAXUINT16};
    ...
    for (int i = 0; i < sizeof(test_cases) / sizeof(test_cases[0]); i++)
    {
        read_responder_public_certificate_chain_by_size(
            m_use_hash_algo, m_use_asym_algo, test_cases[i], &data, &data_size,
            NULL, NULL);
 ...
 **/
void test_spdm_requester_encap_certificate_case6(void **state)
{
    return_status status;
    spdm_test_context_t *spdm_test_context;
    spdm_context_t *spdm_context;
...
spdm_test_context_t m_spdm_requester_certificate_test_context = {
    SPDM_TEST_CONTEXT_SIGNATURE,
    false,
};

int spdm_requester_encap_certificate_test_main(void)
{
    const struct CMUnitTest spdm_responder_certificate_tests[] = {
        /* Success Case*/
        cmocka_unit_test(test_spdm_requester_encap_certificate_case1),
        /* Bad request size*/
        cmocka_unit_test(test_spdm_requester_encap_certificate_case2),
        /* Tests varying length*/
        cmocka_unit_test(test_spdm_requester_encap_certificate_case3),
        /* Tests varying offset*/
        cmocka_unit_test(test_spdm_requester_encap_certificate_case4),
        /* Tests large certificate chains*/
        cmocka_unit_test(test_spdm_requester_encap_certificate_case5),
        /* Requests byte by byte*/
        cmocka_unit_test(test_spdm_requester_encap_certificate_case6),
    };

    setup_spdm_test_context(&m_spdm_requester_certificate_test_context);
