 ...
 **/
void libspdm_test_responder_receive_send_rsp_case9(void** state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
 ...
 **/
void libspdm_test_responder_receive_send_rsp_case10(void** state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
...
void libspdm_test_responder_receive_send_rsp_case11(void** state)
{
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
 ...
 **/
void libspdm_test_responder_receive_send_rsp_case12(void** state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
 ...
 * (policy bit set).
 **/
void libspdm_test_responder_receive_send_rsp_case13(void** state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
 ...
 **/
void libspdm_test_responder_receive_send_rsp_case14(void** state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
