...
static void rsp_psk_exchange_rsp_case2(void **state)
{
    ...
    opaque_psk_exchange_req_size =
        libspdm_get_opaque_data_supported_version_data_size(spdm_context);
    m_libspdm_psk_exchange_request2.opaque_length = (uint16_t)opaque_psk_exchange_req_size;
...
static void rsp_psk_exchange_rsp_case10(void **state)
{
    ...
    opaque_psk_exchange_req_size =
        libspdm_get_opaque_data_supported_version_data_size(spdm_context);
    m_libspdm_psk_exchange_request4.opaque_length = (uint16_t)opaque_psk_exchange_req_size;
...
static void rsp_psk_exchange_rsp_case11(void **state)
{
    ...
    opaque_psk_exchange_req_size =
        libspdm_get_opaque_data_supported_version_data_size(spdm_context);
    m_libspdm_psk_exchange_request5.opaque_length = (uint16_t)opaque_psk_exchange_req_size;
...
static void rsp_psk_exchange_rsp_case12(void **state)
{
    ...
    opaque_psk_exchange_req_size =
        libspdm_get_opaque_data_supported_version_data_size(spdm_context);
    m_libspdm_psk_exchange_request6.opaque_length = (uint16_t)opaque_psk_exchange_req_size;
...
static void rsp_psk_exchange_rsp_case14(void **state)
{
    ...
    opaque_psk_exchange_req_size =
        libspdm_get_opaque_data_supported_version_data_size(spdm_context);
    m_libspdm_psk_exchange_request7.opaque_length = (uint16_t)opaque_psk_exchange_req_size;
...
static void rsp_psk_exchange_rsp_case15(void **state)
{
    ...
    m_libspdm_psk_exchange_request8.opaque_length = (uint16_t)opaque_psk_exchange_req_size;
...
static void rsp_psk_exchange_rsp_case16(void **state)
{
    ...
    opaque_psk_exchange_req_size = 0;
    m_libspdm_psk_exchange_request9.opaque_length = (uint16_t)opaque_psk_exchange_req_size;
 ...
 **/
static void rsp_psk_exchange_rsp_case19(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
    ...
    assert_int_equal(libspdm_watchdog_get_stats()->start_session_id, spdm_context->session_info[0].session_id);
...
/**
 * Test 20: the Responder does not require PSK_FINISH, so PSK_EXCHANGE_RSP establishes
 * the session, and Heartbeat is supported but the HeartbeatPeriod is zero.
 * Expected behavior: the Responder does not start a watchdog.
 **/
static void rsp_psk_exchange_rsp_case20(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
