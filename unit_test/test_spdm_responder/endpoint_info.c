...
libspdm_return_t endpoint_info_device_func(
...
libspdm_return_t endpoint_info_device_func_too_large(
    void *spdm_context, uint8_t sub_code,
    uint32_t *endpoint_info_size, void *endpoint_info)
{
    if (endpoint_info_size == NULL) {
    ...
    switch (sub_code) {
    case SPDM_GET_ENDPOINT_INFO_REQUEST_SUBCODE_DEVICE_CLASS_IDENTIFIER:
        *endpoint_info_size = LIBSPDM_MAX_SPDM_MSG_SIZE;
        break;
    default:
        return LIBSPDM_STATUS_INVALID_PARAMETER;
    }
...
spdm_get_endpoint_info_request_max_t m_libspdm_get_endpoint_info_request5 = {
    { SPDM_MESSAGE_VERSION_13, SPDM_GET_ENDPOINT_INFO,
...
size_t m_libspdm_get_endpoint_info_request5_size =
    sizeof(spdm_get_endpoint_info_request_t) + SPDM_NONCE_SIZE;

/* request signature, correct, with slot_id == 0x1 */
spdm_get_endpoint_info_request_max_t m_libspdm_get_endpoint_info_request6 = {
    { SPDM_MESSAGE_VERSION_13, SPDM_GET_ENDPOINT_INFO,
...
size_t m_libspdm_get_endpoint_info_request6_size =
    sizeof(spdm_get_endpoint_info_request_t) + SPDM_NONCE_SIZE;

/* request signature, but sub_code invalid */
spdm_get_endpoint_info_request_max_t m_libspdm_get_endpoint_info_request7 = {
    { SPDM_MESSAGE_VERSION_13, SPDM_GET_ENDPOINT_INFO,
      2, 0},
    SPDM_GET_ENDPOINT_INFO_REQUEST_ATTRIBUTE_SIGNATURE_REQUESTED,
    {0, 0, 0},
...
size_t m_libspdm_get_endpoint_info_request7_size =
    sizeof(spdm_get_endpoint_info_request_t) + SPDM_NONCE_SIZE;

/* not request signature, correct */
spdm_get_endpoint_info_request_max_t m_libspdm_get_endpoint_info_request8 = {
    { SPDM_MESSAGE_VERSION_13, SPDM_GET_ENDPOINT_INFO,
      SPDM_GET_ENDPOINT_INFO_REQUEST_SUBCODE_DEVICE_CLASS_IDENTIFIER, 0},
    0,
    {0, 0, 0},
};
size_t m_libspdm_get_endpoint_info_request8_size =
    sizeof(spdm_get_endpoint_info_request_t);
...
void libspdm_test_responder_endpoint_info_case1(void **state)
{
    ...
    spdm_context->endpoint_info_device_func =
        endpoint_info_device_func;
    session_info = NULL;
 ...
 **/
void libspdm_test_responder_endpoint_info_case6(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
 ...
 **/
void libspdm_test_responder_endpoint_info_case7(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
 ...
 * Expected Behavior: generate an ERROR_RESPONSE with code SPDM_ERROR_CODE_UNSUPPORTED_REQUEST
 **/
void libspdm_test_responder_endpoint_info_case8(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
 ...
 * Expected Behavior: generate an ERROR_RESPONSE with code SPDM_ERROR_CODE_INVALID_REQUEST
 **/
void libspdm_test_responder_endpoint_info_case9(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
 ...
 * Expected Behavior: generate an ERROR_RESPONSE with code SPDM_ERROR_CODE_INVALID_REQUEST
 **/
void libspdm_test_responder_endpoint_info_case10(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
 ...
 * Expected Behavior: generate an ERROR_RESPONSE with code SPDM_ERROR_CODE_INVALID_REQUEST
 **/
void libspdm_test_responder_endpoint_info_case11(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
 ...
 * Expected Behavior: generate an ERROR_RESPONSE with code SPDM_ERROR_CODE_INVALID_REQUEST
 **/
void libspdm_test_responder_endpoint_info_case12(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
    ...
    response_size = sizeof(response);
    libspdm_get_random_number(SPDM_NONCE_SIZE,
                              m_libspdm_get_endpoint_info_request5.nonce);

    status = libspdm_get_response_endpoint_info(
        spdm_context, m_libspdm_get_endpoint_info_request5_size,
        &m_libspdm_get_endpoint_info_request5, &response_size, response);
...
/**
 * Test 13: Successful response to get endpoint_info with signature, slot_id == 0xF
 * Expected Behavior: get a RETURN_SUCCESS return code,
 *                    correct transcript.message_e size,
 *                    correct response message size and fields
 *                    correct signature verification
 **/
void libspdm_test_responder_endpoint_info_case13(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
    ...
    /* signature verification */
    status = libspdm_append_message_e(spdm_context, session_info,
                                      &m_libspdm_get_endpoint_info_request5,
                                      m_libspdm_get_endpoint_info_request5_size);
    assert_int_equal(status, LIBSPDM_STATUS_SUCCESS);
...
/**
 * Test 14: Error case, signature was required, multi_key_conn_rsp is set
 *          but local_key_usage_bit_mask[slot_id] not meet requirement
 * Expected Behavior: generate an ERROR_RESPONSE with code SPDM_ERROR_CODE_INVALID_REQUEST
 **/
void libspdm_test_responder_endpoint_info_case14(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
    ...
    response_size = sizeof(response);
    libspdm_get_random_number(SPDM_NONCE_SIZE,
                              m_libspdm_get_endpoint_info_request6.nonce);

    status = libspdm_get_response_endpoint_info(
        spdm_context, m_libspdm_get_endpoint_info_request6_size,
        &m_libspdm_get_endpoint_info_request6, &response_size, response);
...
/**
 * Test 15: Successful response to get endpoint_info with signature,
 ...
 *                    correct signature verification
 **/
void libspdm_test_responder_endpoint_info_case15(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
    ...
    /* signature verification */
    status = libspdm_append_message_e(spdm_context, session_info,
                                      &m_libspdm_get_endpoint_info_request6,
                                      m_libspdm_get_endpoint_info_request6_size);
    assert_int_equal(status, LIBSPDM_STATUS_SUCCESS);
...
/**
 * Test 16: Error case, no endpoint_info_device_func registered
 * Expected Behavior: generate an ERROR_RESPONSE with code SPDM_ERROR_CODE_UNSUPPORTED_REQUEST
 **/
void libspdm_test_responder_endpoint_info_case16(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
    ...
    spdm_context->connection_info.algorithm.base_asym_algo =
        m_libspdm_use_asym_algo;
    spdm_context->endpoint_info_device_func = NULL; /* no endpoint_info_device_func */
...
/**
 * Test 17: Error case, invalid sub_code
 * Expected Behavior: generate an ERROR_RESPONSE with code SPDM_ERROR_CODE_INVALID_REQUEST
 **/
void libspdm_test_responder_endpoint_info_case17(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
    ...
    response_size = sizeof(response);
    libspdm_get_random_number(SPDM_NONCE_SIZE,
                              m_libspdm_get_endpoint_info_request7.nonce);

    status = libspdm_get_response_endpoint_info(
        spdm_context, m_libspdm_get_endpoint_info_request7_size,
        &m_libspdm_get_endpoint_info_request7, &response_size, response);
...
/**
 * Test 18: Error case, endpoint_info_device_func returns ep_info_size too large.
 * Expected Behavior: generate an ERROR_RESPONSE with code SPDM_ERROR_CODE_UNSUPPORTED_REQUEST
 **/
void libspdm_test_responder_endpoint_info_case18(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
    ...
    spdm_context->connection_info.algorithm.base_asym_algo =
        m_libspdm_use_asym_algo;
    spdm_context->endpoint_info_device_func =
        endpoint_info_device_func_too_large;
    session_info = NULL;
...
/**
 * Test 19: Successful response to get endpoint_info without signature
 * Expected Behavior: get a RETURN_SUCCESS return code,
 *                    correct response message size and fields
 **/
void libspdm_test_responder_endpoint_info_case19(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
    ...
    response_size = sizeof(response);
    status = libspdm_get_response_endpoint_info(
        spdm_context, m_libspdm_get_endpoint_info_request8_size,
        &m_libspdm_get_endpoint_info_request8, &response_size, response);
...
/**
 * Test 20: Successful response to get session-based endpoint_info with signature
 * Expected Behavior: get a RETURN_SUCCESS return code,
 *                    correct transcript.message_e size,
 *                    correct response message size and fields
 *                    correct signature verification
 **/
void libspdm_test_responder_endpoint_info_case20(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
...
int libspdm_responder_endpoint_info_test_main(void)
{
    const struct CMUnitTest spdm_responder_endpoint_info_tests[] = {
        ...
        cmocka_unit_test(libspdm_test_responder_endpoint_info_case6),
        cmocka_unit_test(libspdm_test_responder_endpoint_info_case7),
        cmocka_unit_test(libspdm_test_responder_endpoint_info_case8),
        cmocka_unit_test(libspdm_test_responder_endpoint_info_case9),
        cmocka_unit_test(libspdm_test_responder_endpoint_info_case10),
        cmocka_unit_test(libspdm_test_responder_endpoint_info_case11),
        cmocka_unit_test(libspdm_test_responder_endpoint_info_case12),
        cmocka_unit_test(libspdm_test_responder_endpoint_info_case13),
        cmocka_unit_test(libspdm_test_responder_endpoint_info_case14),
        cmocka_unit_test(libspdm_test_responder_endpoint_info_case15),
        cmocka_unit_test(libspdm_test_responder_endpoint_info_case16),
        cmocka_unit_test(libspdm_test_responder_endpoint_info_case17),
        cmocka_unit_test(libspdm_test_responder_endpoint_info_case18),
        cmocka_unit_test(libspdm_test_responder_endpoint_info_case19),
        cmocka_unit_test(libspdm_test_responder_endpoint_info_case20),
    };
