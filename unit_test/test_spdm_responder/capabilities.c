 ...
 **/
static void rsp_capabilities_case40_supported_algorithms(void **state)
{
    libspdm_return_t status;
    libspdm_test_context_t *spdm_test_context;
    libspdm_context_t *spdm_context;
    ...
    assert_int_equal(spdm_response->flags,
                     SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_CHUNK_CAP |
                     SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_MULTI_KEY_CAP_ONLY |
                     SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_GET_KEY_PAIR_INFO_CAP |
                     SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_CERT_CAP |
    ...
    assert_int_equal(supported_algorithms->length,
                     sizeof(spdm_supported_algorithms_block_t) +
    ...
    assert_int_equal(supported_algorithms->pqc_asym_algo,
                     SPDM_ALGORITHMS_PQC_ASYM_ALGO_ML_DSA_44);
}
...
int libspdm_rsp_capabilities_test(void)
{
    const struct CMUnitTest test_cases[] = {
        ...
        /* SPDM 1.2 request smaller than the fixed structure */
        cmocka_unit_test(rsp_capabilities_case11),
        /* SPDM 1.1 request smaller than the fixed structure */
        ...
        /* Transcript appends GET_CAPABILITIES/CAPABILITIES after existing message A data */
        ...
        /* SPDM 1.4 SupportedAlgorithms response includes the advertised algorithm block */
