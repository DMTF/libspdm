...
uintn m_libspdm_finish_request2_size = LIBSPDM_MAX_MESSAGE_BUFFER_SIZE;

libspdm_finish_request_mine_t m_libspdm_finish_request3 = {
    { SPDM_MESSAGE_VERSION_11, SPDM_FINISH, 1, 0 },
};
uintn m_libspdm_finish_request3_size = sizeof(m_libspdm_finish_request3);
...
void libspdm_test_responder_finish_case13(void **state)
{
    ...
    libspdm_hmac_all(m_libspdm_use_hash_algo, libspdm_get_managed_buffer(&th_curr),
                     libspdm_get_managed_buffer_size(&th_curr), request_finished_key,
                     hash_size, ptr);
    copy_mem(ptr, sizeof(m_libspdm_finish_request1.signature),
...
void libspdm_test_responder_finish_case15(void **state)
{
    ...
    libspdm_hmac_all(m_libspdm_use_hash_algo, libspdm_get_managed_buffer(&th_curr),
                     libspdm_get_managed_buffer_size(&th_curr), request_finished_key,
                     hash_size, ptr);
    set_mem(m_libspdm_finish_request3.signature,
