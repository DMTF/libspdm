...
//
GLOBAL_REMOVE_IF_UNREFERENCED const uint8 m_rsa_n[] = {
...
//
GLOBAL_REMOVE_IF_UNREFERENCED const uint8 m_rsa_e[] = { 0x11 };

//
// Private Exponent of RSA key
//
GLOBAL_REMOVE_IF_UNREFERENCED const uint8 m_rsa_d[] = {
...
//
GLOBAL_REMOVE_IF_UNREFERENCED const uint8 m_rsa_pkcs1_signature[] = {
...
//
GLOBAL_REMOVE_IF_UNREFERENCED const uint8 m_default_public_key[] = { 0x01, 0x00,
								     0x01 };
