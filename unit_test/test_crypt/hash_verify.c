...
LIBSPDM_GLOBAL_REMOVE_IF_UNREFERENCED const char *m_libspdm_hash_data = "abc";


/* result for SHA-256("abc"). (from "B.1 SHA-256 Example" of NIST FIPS 180-2)*/

LIBSPDM_GLOBAL_REMOVE_IF_UNREFERENCED uint8_t m_libspdm_sha256_digest[LIBSPDM_SHA256_DIGEST_SIZE] =
{
...
LIBSPDM_GLOBAL_REMOVE_IF_UNREFERENCED uint8_t m_libspdm_sha384_digest[LIBSPDM_SHA384_DIGEST_SIZE] =
{
...
LIBSPDM_GLOBAL_REMOVE_IF_UNREFERENCED uint8_t m_libspdm_sha512_digest[LIBSPDM_SHA512_DIGEST_SIZE] =
{
...
LIBSPDM_GLOBAL_REMOVE_IF_UNREFERENCED uint8_t
