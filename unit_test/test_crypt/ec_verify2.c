...
GLOBAL_REMOVE_IF_UNREFERENCED uint8_t m_libspdm_ecc_test_root_cer[] = {
...
GLOBAL_REMOVE_IF_UNREFERENCED uint8_t m_libspdm_ecc_test_pem_key[] = {
...
GLOBAL_REMOVE_IF_UNREFERENCED const char *m_libspdm_ec_payload =
