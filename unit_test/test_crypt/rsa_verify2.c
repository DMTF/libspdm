...
GLOBAL_REMOVE_IF_UNREFERENCED const uint8_t m_test_cert[] = {
...
GLOBAL_REMOVE_IF_UNREFERENCED const uint8_t m_test_ca_cert[] = {
...
GLOBAL_REMOVE_IF_UNREFERENCED const uint8_t m_test_key_pem[] = {
...
GLOBAL_REMOVE_IF_UNREFERENCED const uint8_t m_msg_hash[] = {
...
return_status validate_crypt_rsa_2(void)
{
    ...
    status = rsa_pkcs1_sign_with_nid(rsa_priv_key, CRYPTO_NID_SHA256,
                     m_msg_hash, SHA256_DIGEST_SIZE, NULL,
                     &sig_size);
    ...
    /* status  = x509_get_subject_name (m_test_cert, sizeof (m_test_cert), subject, &subject_size);*/
    /* if (!status) {*/
    /*   my_print ("[Fail]");*/
    /*   rsa_free  (rsa_pub_key);*/
    /*   rsa_free  (rsa_priv_key);*/
