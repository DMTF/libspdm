...
uint8_t m_libspdm_test_ca_cert[] = {
 ...
 * (Generated by OpenSSL utility).*/
uint8_t m_libspdm_test_key_pem[] = {
...
const char *m_libspdm_pem_pass = "client";

/* DER key data for RSA Public key Retrieving (Extracted from m_libspdm_test_key_pem). */
uint8_t m_libspdm_test_pub_key_der[] = {
    
};

/* Message hash for Signing & Verification Validation. */
uint8_t m_libspdm_msg_hash[] = {
...
const char *m_libspdm_payload = "payload data for PKCS#7 Signing";
...
bool libspdm_validate_crypt_rsa_2(void)
{
    ...
    libspdm_my_print("\n- Retrieve RSA Private key from PEM ...");
    ...
    libspdm_my_print("\n- Retrieve RSA Public key from DER ...");
    status = libspdm_rsa_get_public_key_from_der(m_libspdm_test_pub_key_der,
                                                 sizeof(m_libspdm_test_pub_key_der),
                                                 &rsa_pub_key);
    if (!status) {
        libspdm_my_print("[Fail]");
        free_pool(signature);
    ...
    libspdm_my_print("\n- PKCS#1 signature Verification using Public key from DER ... ");
    ...
    /* Verify RSA PKCS#1-encoded signature. */
    libspdm_my_print("\n- PKCS#1 signature Verification using Public key from X509 ... ");
    status = libspdm_rsa_pkcs1_verify_with_nid(rsa_pub_key, LIBSPDM_CRYPTO_NID_SHA256,
                                               m_libspdm_msg_hash, LIBSPDM_SHA256_DIGEST_SIZE,
                                               signature, sig_size);
    if (!status) {
