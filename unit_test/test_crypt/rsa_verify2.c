...
GLOBAL_REMOVE_IF_UNREFERENCED uint8_t m_libspdm_test_cert[] = {
...
GLOBAL_REMOVE_IF_UNREFERENCED uint8_t m_libspdm_test_ca_cert[] = {
...
GLOBAL_REMOVE_IF_UNREFERENCED uint8_t m_libspdm_test_key_pem[] = {
...
GLOBAL_REMOVE_IF_UNREFERENCED const char *m_libspdm_pem_pass = "client";


/* message hash for Signing & Verification Validation.*/

GLOBAL_REMOVE_IF_UNREFERENCED uint8_t m_libspdm_msg_hash[] = {
...
GLOBAL_REMOVE_IF_UNREFERENCED const char *m_libspdm_payload =
