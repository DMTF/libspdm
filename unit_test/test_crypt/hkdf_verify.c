...
GLOBAL_REMOVE_IF_UNREFERENCED const uint8 m_hkdf_sha256_ikm[22] = {
	0x0b, 0x0b, 0x0b, 0x0b, 0x0b, 0x0b, 0x0b, 0x0b, 0x0b, 0x0b,
	0x0b, 0x0b, 0x0b, 0x0b, 0x0b, 0x0b, 0x0b, 0x0b, 0x0b, 0x0b,
	0x0b, 0x0b
};

GLOBAL_REMOVE_IF_UNREFERENCED const uint8 m_hkdf_sha256_salt[13] = {
	0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09,
	0x0a, 0x0b, 0x0c,
};

GLOBAL_REMOVE_IF_UNREFERENCED const uint8 m_hkdf_sha256_info[10] = {
	0xf0, 0xf1, 0xf2, 0xf3, 0xf4, 0xf5, 0xf6, 0xf7, 0xf8, 0xf9,
};

GLOBAL_REMOVE_IF_UNREFERENCED const uint8 m_hkdf_sha256_prk[32] = {
...
GLOBAL_REMOVE_IF_UNREFERENCED const uint8 m_hkdf_sha256_okm[42] = {
...
return_status validate_crypt_hkdf(void)
{
	...
	if (const_compare_mem(prk_out, m_hkdf_sha256_prk, sizeof(m_hkdf_sha256_prk)) !=
	    0) {
		my_print("[Fail]");
		return RETURN_ABORTED;
	}
	...
	my_print("Check value... ");
	if (const_compare_mem(out, m_hkdf_sha256_okm, sizeof(m_hkdf_sha256_okm)) !=
	    0) {
		my_print("[Fail]");
		return RETURN_ABORTED;
	}
