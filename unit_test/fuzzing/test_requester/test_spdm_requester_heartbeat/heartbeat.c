...
void spdm_secured_message_set_response_data_encryption_key(IN void *spdm_secured_message_context,
...
void run_test_harness(IN void *test_buffer, IN uintn test_buffer_size)
{
    ...
    m_spdm_requester_heartbeat_test_context.test_buffer = test_buffer;
    m_spdm_requester_heartbeat_test_context.test_buffer_size = test_buffer_size;
