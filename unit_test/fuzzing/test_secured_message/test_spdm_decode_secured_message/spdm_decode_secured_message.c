...
void test_spdm_decode_secured_message(void **State)
{
    ...
    spdm_decode_secured_message(secured_message_context, session_id, is_requester,
                                spdm_test_context->test_buffer_size, spdm_test_context->test_buffer,
                                &app_message_size, app_message, &spdm_secured_message_callbacks_t);
}
...
void run_test_harness(IN void *test_buffer, IN uintn test_buffer_size)
{
    ...
    test_spdm_decode_secured_message(&State);
