...
void test_spdm_responder_digests_case1(void **State)
{
    ...
    spdm_get_response_digests(spdm_context, spdm_test_context->test_buffer_size,
...
void run_test_harness(IN void *test_buffer, IN uintn test_buffer_size)
{
    ...
    m_spdm_responder_digests_test_context.test_buffer = test_buffer;
    m_spdm_responder_digests_test_context.test_buffer_size = test_buffer_size;
