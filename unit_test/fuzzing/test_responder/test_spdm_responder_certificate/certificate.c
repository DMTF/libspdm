...
void test_spdm_responder_certificate_case1(void **State)
{
    ...
    spdm_get_response_certificate(spdm_context, spdm_test_context->test_buffer_size,
...
void run_test_harness(IN void *test_buffer, IN uintn test_buffer_size)
{
    ...
    m_spdm_responder_certificate_test_context.test_buffer_size = test_buffer_size;
