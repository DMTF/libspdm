...
void libspdm_test_transport_storage_encode_message(void **state)
{
    ...
    libspdm_storage_transport_virtual_header_t *hdr;
...
void libspdm_test_transport_storage_encode_discovery_response(void **state)
{
    ...
    LIBSPDM_ASSERT(d_resp->storage_response_headers.data_length ==
                   sizeof(spdm_storage_discovery_response_t));
    LIBSPDM_ASSERT(d_resp->storage_response_headers.storage_binding_version ==
...
void libspdm_test_transport_storage_encode_pending_resp(void **state)
{
    ...
    LIBSPDM_ASSERT(p_resp->storage_response_headers.data_length ==
                   sizeof(spdm_storage_pending_info_response_t));
    LIBSPDM_ASSERT(p_resp->storage_response_headers.storage_binding_version ==
                   SPDM_STORAGE_SECURITY_BINDING_VERSION);
