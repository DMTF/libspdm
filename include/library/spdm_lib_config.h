 ...
 * It may be used to hold the large request/response in case of chunking.
 *
 ...
 */
#define LIBSPDM_SCRATCH_BUFFER_SIZE (LIBSPDM_SENDER_RECEIVE_BUFFER_SIZE + LIBSPDM_MAX_SPDM_MSG_SIZE)
