...
#if defined(LIBSPDM_ENABLE_SET_CERTIFICATE_CAP) && !defined(LIBSPDM_ENABLE_CAPABILITY_SET_CERTIFICATE_CAP)
#ifdef _MSC_VER
#pragma message("LIBSPDM_ENABLE_SET_CERTIFICATE_CAP is deprecated. Use \
LIBSPDM_ENABLE_CAPABILITY_SET_CERTIFICATE_CAP instead. This warning will be removed with the next \
release.")
#else
...
#ifdef _MSC_VER
#pragma message("LIBSPDM_ENABLE_CHUNK_CAP is deprecated. Use \
LIBSPDM_ENABLE_CAPABILITY_CHUNK_CAP instead. This warning will be removed with the next release.")
#else
