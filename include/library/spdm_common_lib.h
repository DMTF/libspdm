...
typedef enum {
    ...
    LIBSPDM_DATA_LOCAL_KEY_PAIR_INFO,

    LIBSPDM_DATA_LOCAL_CURRENT_BANK,
    LIBSPDM_DATA_LOCAL_SLOT_MANAGEMENT_SUBCODES,
    LIBSPDM_DATA_LOCAL_BANK_ASYM_ALGO,
    LIBSPDM_DATA_LOCAL_BANK_PQC_ASYM_ALGO,
 ...
 * +--------------------------+------------------------------------------+---------+
 */
#define LIBSPDM_MAX_MESSAGE_VCA_BUFFER_SIZE (300)
