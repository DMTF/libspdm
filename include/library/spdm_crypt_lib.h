...
**/
typedef boolean (*hash_final_func)(IN OUT void *hash_context, OUT uint8_t *hash_value);
...
**/
typedef boolean (*hmac_final_func)(IN OUT void *hmac_ctx, OUT uint8_t *hmac_value);
