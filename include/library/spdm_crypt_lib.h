...
#endif /* LIBSPDM_MAX_ASYM_SIG_SIZE */
...
#define LIBSPDM_MAX_KEM_CT_SIZE 1568
#define LIBSPDM_MAX_KEM_SS_SIZE 32
#elif (LIBSPDM_ML_KEM_768_SUPPORT)
#define LIBSPDM_MAX_KEM_ENCAP_KEY_SIZE 1184
#define LIBSPDM_MAX_KEM_DECAP_KEY_SIZE 2400
#define LIBSPDM_MAX_KEM_CT_SIZE 1088
#define LIBSPDM_MAX_KEM_SS_SIZE 32
#elif (LIBSPDM_ML_KEM_512_SUPPORT)
#define LIBSPDM_MAX_KEM_ENCAP_KEY_SIZE 800
#define LIBSPDM_MAX_KEM_DECAP_KEY_SIZE 1632
#define LIBSPDM_MAX_KEM_CT_SIZE 768
#define LIBSPDM_MAX_KEM_SS_SIZE 32
#else
/* set 1 to pass build only */
#define LIBSPDM_MAX_KEM_ENCAP_KEY_SIZE 1
#define LIBSPDM_MAX_KEM_DECAP_KEY_SIZE 1
#define LIBSPDM_MAX_KEM_CT_SIZE 1
#define LIBSPDM_MAX_KEM_SS_SIZE 1
#endif

#if ((LIBSPDM_SLH_DSA_SHA2_256F_SUPPORT) || (LIBSPDM_SLH_DSA_SHAKE_256F_SUPPORT))
#define LIBSPDM_MAX_PQC_ASYM_SIG_SIZE 49856
#elif ((LIBSPDM_SLH_DSA_SHA2_192F_SUPPORT) || (LIBSPDM_SLH_DSA_SHAKE_192F_SUPPORT))
#define LIBSPDM_MAX_PQC_ASYM_SIG_SIZE 35664
#elif ((LIBSPDM_SLH_DSA_SHA2_256S_SUPPORT) || (LIBSPDM_SLH_DSA_SHAKE_256S_SUPPORT))
#define LIBSPDM_MAX_PQC_ASYM_SIG_SIZE 29792
#elif ((LIBSPDM_SLH_DSA_SHA2_128F_SUPPORT) || (LIBSPDM_SLH_DSA_SHAKE_128F_SUPPORT))
#define LIBSPDM_MAX_PQC_ASYM_SIG_SIZE 17088
#elif ((LIBSPDM_SLH_DSA_SHA2_192S_SUPPORT) || (LIBSPDM_SLH_DSA_SHAKE_192S_SUPPORT))
#define LIBSPDM_MAX_PQC_ASYM_SIG_SIZE 16224
#elif ((LIBSPDM_SLH_DSA_SHA2_128S_SUPPORT) || (LIBSPDM_SLH_DSA_SHAKE_128S_SUPPORT))
#define LIBSPDM_MAX_PQC_ASYM_SIG_SIZE 7856
...
#if (LIBSPDM_MAX_KEM_CT_SIZE > LIBSPDM_MAX_DHE_KEY_SIZE)
#define LIBSPDM_RSP_EXCHANGE_DATA_MAX_SIZE LIBSPDM_MAX_KEM_CT_SIZE
#else
#define LIBSPDM_RSP_EXCHANGE_DATA_MAX_SIZE LIBSPDM_MAX_DHE_KEY_SIZE
#endif

#if (LIBSPDM_MAX_PQC_ASYM_SIG_SIZE > LIBSPDM_MAX_ASYM_SIG_SIZE)
#define LIBSPDM_REQ_SIGNATURE_DATA_MAX_SIZE LIBSPDM_MAX_PQC_ASYM_SIG_SIZE
#else
#define LIBSPDM_REQ_SIGNATURE_DATA_MAX_SIZE LIBSPDM_MAX_ASYM_SIG_SIZE
#endif

#if (LIBSPDM_MAX_PQC_ASYM_SIG_SIZE > LIBSPDM_MAX_ASYM_SIG_SIZE)
#define LIBSPDM_RSP_SIGNATURE_DATA_MAX_SIZE LIBSPDM_MAX_PQC_ASYM_SIG_SIZE
#else
#define LIBSPDM_RSP_SIGNATURE_DATA_MAX_SIZE LIBSPDM_MAX_ASYM_SIG_SIZE
#endif
