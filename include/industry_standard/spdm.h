...
#define SPDM_ALGORITHMS_OPAQUE_DATA_FORMAT_MASK 0x3
...
#define SPDM_MEASUREMENT_BLOCK_MEASUREMENT_TYPE_MASK 0x7F
...
#define SPDM_KEY_UPDATE_OPERATIONS_UPDATE_KEY 1
#define SPDM_KEY_UPDATE_OPERATIONS_UPDATE_ALL_KEYS 2
#define SPDM_KEY_UPDATE_OPERATIONS_VERIFY_NEW_KEY 3
