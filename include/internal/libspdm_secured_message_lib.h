...
#if LIBSPDM_MAX_DHE_KEY_SIZE >= LIBSPDM_MAX_KEM_SS_KEY_SIZE
#define LIBSPDM_MAX_SHARED_KEY_SIZE LIBSPDM_MAX_DHE_KEY_SIZE
#else
#define LIBSPDM_MAX_SHARED_KEY_SIZE LIBSPDM_MAX_KEM_SS_KEY_SIZE
#endif

typedef struct {
    uint8_t shared_secret[LIBSPDM_MAX_SHARED_KEY_SIZE];
