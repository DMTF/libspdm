...
#if (LIBSPDM_SENDER_DATA_TRANSFER_SIZE < SPDM_MIN_DATA_TRANSFER_SIZE_VERSION_12)
    #error LIBSPDM_SENDER_DATA_TRANSFER_SIZE must be no less than 42
#endif

#if (LIBSPDM_RECEIVER_DATA_TRANSFER_SIZE < SPDM_MIN_DATA_TRANSFER_SIZE_VERSION_12)
    #error LIBSPDM_RECEIVER_DATA_TRANSFER_SIZE must be no less than 42
#endif

#if (LIBSPDM_MAX_SPDM_MSG_SIZE < LIBSPDM_SENDER_DATA_TRANSFER_SIZE)
    #error LIBSPDM_MAX_SPDM_MSG_SIZE should be no less than LIBSPDM_SENDER_DATA_TRANSFER_SIZE
#endif

#if (LIBSPDM_MAX_SPDM_MSG_SIZE < LIBSPDM_RECEIVER_DATA_TRANSFER_SIZE)
    #error LIBSPDM_MAX_SPDM_MSG_SIZE must be no less than LIBSPDM_RECEIVER_DATA_TRANSFER_SIZE
#endif
