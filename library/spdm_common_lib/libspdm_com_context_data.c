                                  ...
                                  size_t data_size)
{
    ...
    case LIBSPDM_DATA_SPDM_VERSION_10_11_VERIFY_SIGNATURE_ENDIAN:
        if (data_size != sizeof(libspdm_spdm_10_11_verify_signature_endian_t)) {
            return LIBSPDM_STATUS_INVALID_PARAMETER;
        }
        ...
        context->spdm_10_11_verify_signature_endian =
            *(libspdm_spdm_10_11_verify_signature_endian_t*)data;
        break;
    default:
                                  ...
                                  void *data, size_t *data_size)
{
    ...
    case LIBSPDM_DATA_VCA_CACHE:
        ...
        break;
    case LIBSPDM_DATA_SPDM_VERSION_10_11_VERIFY_SIGNATURE_ENDIAN:
        target_data_size = sizeof(libspdm_spdm_10_11_verify_signature_endian_t);
