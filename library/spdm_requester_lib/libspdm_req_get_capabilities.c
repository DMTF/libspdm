                                                     ...
                                                     void *supported_algs)
{
    ...
    if (get_supported_algorithms && supported_algs != NULL &&
        ...
        /* TODO: When SPDM 1.4 is supported, add version check and handling:
         * if (spdm_response->header.spdm_version >= SPDM_MESSAGE_VERSION_14) {
         *     // Handle SPDM 1.4 specific algorithm structure
         *     libspdm_responder_supported_algorithms_14_t *dst = (libspdm_responder_supported_algorithms_14_t *)supported_algs;
         *     // Copy SPDM 1.4 specific algorithm data
         * } else
         */
        libspdm_responder_supported_algorithms_13_t *dst =
            (libspdm_responder_supported_algorithms_13_t *)supported_algs;
