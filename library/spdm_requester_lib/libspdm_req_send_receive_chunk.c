...
#include "library/spdm_transport_mctp_lib.h"
  ...
  **/
libspdm_return_t libspdm_send_request_chunk(void* context, const uint32_t* session_id,
    bool is_app_message,
    size_t request_size, void* request)
{
    ...
    //libspdm_trace_message(request, request_size);
 ...
 **/
libspdm_return_t libspdm_receive_response_chunk(void* context, const uint32_t* session_id,
    bool is_app_message,
 ...
 * @retval RETURN_DEVICE_ERROR          A device error occurs when the SPDM request is sent to the device.
 **/
libspdm_return_t libspdm_send_spdm_request_chunk(
    libspdm_context_t* spdm_context,
    ...
    size_t request_size, void* request)
{
    ...
    return libspdm_send_request_chunk(spdm_context,
                                      session_id, false,
    ...
    void** response)
{
    ...
    return libspdm_receive_response_chunk(spdm_context, session_id, false,
