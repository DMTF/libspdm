    ...
    bool is_request_message)
{
    ...
    if (*message_size < LISBPDM_STORAGE_SECURED_MESSAGE_DESCRIPTOR_MIN_SIZE) {
    ...
    if (!is_request_message) {
        ...
        if (*session_id != NULL) {
            ...
            **session_id =
            ...
            status = libspdm_strorage_secured_message_decode(spdm_context, **session_id, message_size,
